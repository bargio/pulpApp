...
public class MapsLocationListener extends Service implements LocationListener {
    ...
    public MapsLocationListener(Context context) {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(MapsLocationListener.this);
        }
    }
